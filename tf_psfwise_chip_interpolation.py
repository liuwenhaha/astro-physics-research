...
def loss(pixel_values, pixel_labels):
    return tf.reduce_sum(tf.squared_difference(pixel_labels, pixel_values), name='mean_square_error')
...
def tf_psfwise_chip_interpolation(self, learning_rate=0.01, hidden1=36, hidden2=144, hidden3=576, max_steps=2000, batch_size=10):
    '''
    ...
    for chip_num in range(36):
        print('Interpolating Chip {}.'.format(chip_num))
        ...
        execute(learning_rate=learning_rate, max_steps=max_steps, hidden1=hidden1,
                ...
                log_dir='assets/log/tf_chipwise/{}_{}/l3_lr{}_ms{}_h1.{}_h2.{}_h3.{}_bs{}/chn{}'
                # log_dir='assets/log/{}_{}/l1_lr{}_ms{}_h1.{}_bs{}'
                .format(self.region, self.exp_num, learning_rate, max_steps,
                       hidden1, hidden2, hidden3, batch_size, chip_num),
                datasets=data_sets)
